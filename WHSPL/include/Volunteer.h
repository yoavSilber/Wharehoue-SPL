...
enum class Volunteertype{
    collector, limited_collector, driver, limited_driver,volunteer
};
class Volunteer {
    public:
        ...
        void resetCompletedOrderId(); // Reset completedOrderId to NO_ORDER we added   
